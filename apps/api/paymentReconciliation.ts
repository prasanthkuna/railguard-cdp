import type { SettlementVerificationStatus } from "../../packages/settlement/src"
import {
  ...
  switch (verificationStatus) {
    case "CONFIRMED":
      return {
        ...
        guardStatus: guardAuthorizationId && !alreadyCommitted ? "committed" : undefined,
    ...
    case "REVERTED":
      return {
        ...
        settlementStatus: mapped.settlementStatus,
        guardStatus: guardAuthorizationId ? "released" : undefined,
