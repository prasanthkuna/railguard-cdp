...
import { validatePaymentContext } from "../../core/src/index.ts";
import {
  authorizePayment,
  buildPaymentFingerprint,
  InMemoryGuardStateStore,
} from "../../policy/src/index.ts";
import { ReceiptLedger, type PaymentReceipt } from "../../receipts/src/index.ts";
...
export interface X402GuardOptions {
  ...
  replayTtlMs?: number;
  stateStore?: import("../../policy/src/index.ts").GuardStateStore;
...
export class X402Guard {
  private readonly stateStore: import("../../policy/src/index.ts").GuardStateStore;
...
export type { AgentPolicyConfig, X402PaymentContext } from "../../core/src/index.ts";
export { defaultDevPolicy } from "../../policy/src/index.ts";
export type { PaymentReceipt } from "../../receipts/src/index.ts";
